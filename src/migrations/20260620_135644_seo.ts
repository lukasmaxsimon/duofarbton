...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "programme" ADD COLUMN "meta_title" varchar;
  ALTER TABLE "programme" ADD COLUMN "meta_description" varchar;
  ALTER TABLE "programme" ADD COLUMN "meta_image_id" integer;
  ...
  ALTER TABLE "programme" ADD CONSTRAINT "programme_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages" ADD CONSTRAINT "pages_meta_image_id_media_id_fk" FOREIGN KEY ("meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v" ADD CONSTRAINT "_pages_v_version_meta_image_id_media_id_fk" FOREIGN KEY ("version_meta_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  CREATE INDEX "programme_meta_meta_image_idx" ON "programme" USING btree ("meta_image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "programme" DROP CONSTRAINT "programme_meta_image_id_media_id_fk";
  ...
  DROP INDEX "programme_meta_meta_image_idx";
  DROP INDEX "pages_meta_meta_image_idx";
  DROP INDEX "_pages_v_version_meta_version_meta_image_idx";
  ALTER TABLE "programme" DROP COLUMN "meta_title";
  ALTER TABLE "programme" DROP COLUMN "meta_description";
  ALTER TABLE "programme" DROP COLUMN "meta_image_id";
